...
void glMatrixMode(GLenum mode){
    GL_SET_COMMAND(c, glMatrixMode);
	c->cmd = GLSC_glMatrixMode;
	c->mode = mode;
	send_data(GLSC_glMatrixMode, (void *)c, sizeof(gl_glMatrixMode_t));
}

void glLoadIdentity(){
    GL_SET_COMMAND(c, glLoadIdentity);
	c->cmd = GLSC_glLoadIdentity;
	send_data(GLSC_glLoadIdentity, (void *)c, sizeof(gl_glLoadIdentity_t)); 
}

void glRotatef(GLfloat angle, GLfloat x, GLfloat y, GLfloat z){
    GL_SET_COMMAND(c, glRotatef);
    c->cmd = GLSC_glRotatef;
    c->angle = angle;
    c->x = x;
    c->y = y;
    c->z = z;
    send_data(GLSC_glRotatef, (void *)c, sizeof(gl_glRotatef_t)); 
}

void glOrtho(GLdouble left, GLdouble right, GLdouble bottom, GLdouble top, GLdouble zNear, GLdouble zFar){
    GL_SET_COMMAND(c, glOrtho);
    c->cmd = GLSC_glOrtho;
    c->left = left;
    c->right = right;
    c->bottom = bottom;
    ...
    c->zNear = zNear;
    c->zFar = zFar;
    send_data(GLSC_glOrtho, (void *)c, sizeof(gl_glOrtho_t)); 
