...
LIBS=-L/usr/lib/ -L./ -lzmq -lglad `pkg-config --libs glfw3` -lpthread
...
client.o: ./glremote/glremote.cpp ./glremote/glremote/glremote_client.h ./glremote/gl_commands.h
	$(CXX) -c   -o client.o $(CXXFLAGS) $(INCLUDES) ./glremote/glremote.cpp 

gl_client: client.cpp client.o
	$(CXX)   -o gl_client $(CXXFLAGS) $(INCLUDES) client.cpp $(CLIENT_OBJS) $(LIBS)

streamer: streamer.cpp
	$(CXX)   -o stremaer $(CXXFLAGS) $(STREAMER_INCLUDES) streamer.cpp $(STREAMER_LIBS)
