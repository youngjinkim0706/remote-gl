...
LIBS=-L/usr/lib/ -L./ -lzmq -lglad `pkg-config --libs glfw3` -lsnappy -lpthread -lrt 
STREAMER_LIBS=-L/usr/lib/ -lzmq `pkg-config --libs gstreamer-1.0` `pkg-config --libs gstreamer-app-1.0` `pkg-config --libs gstreamer-rtsp-server-1.0` -lpthread -lrt
