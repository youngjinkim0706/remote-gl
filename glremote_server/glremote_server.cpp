  ...
  while (!quit) {
    ...
    if (res.has_value()) {
      ...
      case GLSC_glCompileShader: {
        zmq::message_t data_msg;
        auto res = sock.recv(data_msg, zmq::recv_flags::none);
        gl_glCompileShader_t *cmd_data =
            (gl_glCompileShader_t *)data_msg.data();
      ...
      case GLSC_glReadPixels: {
        ...
        glReadPixels(cmd_data->x, cmd_data->y, cmd_data->width,
                     cmd_data->height, cmd_data->format, cmd_data->type,
                     result);

        msg.rebuild(size);

        memcpy(msg.data(), result, size);
      ...
      case GLSC_glCreateProgram: {
        zmq::message_t data_msg;
        auto res = sock.recv(data_msg, zmq::recv_flags::none);
        gl_glCreateProgram_t *cmd_data =
            (gl_glCreateProgram_t *)data_msg.data();
      ...
      case GLSC_glClearBufferfv: {
        zmq::message_t data_msg;
        auto res = sock.recv(data_msg, zmq::recv_flags::none);
        gl_glClearBufferfv_t *cmd_data =
            (gl_glClearBufferfv_t *)data_msg.data();
      ...
      case GLSC_glBufferSubData: {
        ...
        gl_glBufferSubData_t *cmd_data =
            (gl_glBufferSubData_t *)data_msg.data();
        void *buffer_data = malloc(cmd_data->size);
        // float buffer_data[9];
      ...
      case GLSC_bufferSwap: {
        ...
        if (enableStreaming) {
          ...
          // memcpy(zmq_pixel_data.data(), (void *)pixel_data, WIDTH * HEIGHT *
          // 4); ipc_sock.send(zmq_pixel_data, zmq::send_flags::none);
      ...
      case GLSC_glActiveTexture: {
        zmq::message_t data_msg;
        auto res = sock.recv(data_msg, zmq::recv_flags::none);
        gl_glActiveTexture_t *cmd_data =
            (gl_glActiveTexture_t *)data_msg.data();
      ...
      case GLSC_glBlendEquation: {
        zmq::message_t data_msg;
        auto res = sock.recv(data_msg, zmq::recv_flags::none);
        gl_glBlendEquation_t *cmd_data =
            (gl_glBlendEquation_t *)data_msg.data();
      ...
      case GLSC_glVertexAttrib4f: {
        zmq::message_t data_msg;
        auto res = sock.recv(data_msg, zmq::recv_flags::none);
        gl_glVertexAttrib4f_t *cmd_data =
            (gl_glVertexAttrib4f_t *)data_msg.data();
      ...
      case GLSC_glTexParameteri: {
        zmq::message_t data_msg;
        auto res = sock.recv(data_msg, zmq::recv_flags::none);
        gl_glTexParameteri_t *cmd_data =
            (gl_glTexParameteri_t *)data_msg.data();
      ...
      case GLSC_glTexParameterf: {
        zmq::message_t data_msg;
        auto res = sock.recv(data_msg, zmq::recv_flags::none);
        gl_glTexParameterf_t *cmd_data =
            (gl_glTexParameterf_t *)data_msg.data();
      ...
      case GLSC_glTexSubImage2D: {
        ...
        gl_glTexSubImage2D_t *cmd_data =
            (gl_glTexSubImage2D_t *)data_msg.data();
      ...
      case GLSC_glTexSubImage3D: {
        ...
        gl_glTexSubImage3D_t *cmd_data =
            (gl_glTexSubImage3D_t *)data_msg.data();
